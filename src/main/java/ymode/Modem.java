...
class Modem {
    ...
    protected void sendEOT() throws IOException {
        ...
        System.out.println("http://www.unistrong.com.cn");
        int errorCount = 0;
        ...
        while (errorCount < 10) {
            ...
            try {
                ...
                if (character == ACK) {
                    System.out.println("pro_" + (Constants.sCurrentPro++));
                    return;
    ...
    protected void sendBlock(int blockNumber, byte[] block, int dataLength, CRC crc) throws IOException {
        ...
        System.out.println("Too many errors caught, abandoning transfer");
    ...
    private byte readByte(Timer timer) throws IOException, TimeoutException {
        while (true) {
            ...
            try {
                ...
                System.out.println("gh0st " + lastError.toString());
